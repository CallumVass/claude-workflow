...
If a finding requires deeper context (e.g., verifying the correct v4 pattern, checking animation best practices, or confirming migration steps), read the relevant file from `references/`:
